...
SingleCellExperiment::reducedDims(cds)[["UMAP"]] <- sc.combined@reductions$umap.rpca@cell.embeddings
...
pseudotime_plot <- plot_cells(cds,
           ...
           graph_label_size=5,)
ggsave(filename = "./results/competition/pseudotime_plot.png", plot = pseudotime_plot, width = 10, height = 6)
